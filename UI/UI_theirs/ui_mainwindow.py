...
"border:outset")
        ...
        self.MovieEdit.setMinimumSize(QtCore.QSize(65, 80))
...
"border:outset;")
        ...
        self.FormatConvert.setMinimumSize(QtCore.QSize(55, 80))
...
"background-color: rgba(255, 255, 255, 0);")
        ...
        self.labelworldcup.setGeometry(QtCore.QRect(4, 28, 60, 60))
...
"border:outset;")
        ...
        self.buttonsave.setGeometry(QtCore.QRect(20, 0, 122, 72))
        self.buttonsave.setStyleSheet(
"QPushButton {border-image: url(:/images/00-1.png);}\n\
QPushButton:hover:pressed {border-image: url(:/images/00-2.png);}\n\
QPushButton:hover:!pressed {border-image: url(:/images/00-3.png);}"
)
        ...
        self.buttonpreview.setFocusPolicy(QtCore.Qt.NoFocus)
        self.buttonpreview.setFlat(True)
        self.buttonpreview.setGeometry(QtCore.QRect(149, 0, 122, 72))
        self.buttonpreview.setStyleSheet(
"QPushButton {border-image: url(:/images/000-1.png);}\n\
QPushButton:hover:pressed {border-image: url(:/images/000-2.png);}\n\
QPushButton:hover:!pressed {border-image: url(:/images/000-3.png);}"
)
...
"}")
        ...
        self.groupBox_8.setStyleSheet("background-color:  qlineargradient(spread:pad, x1:0, y1:0, x2:0, y2:1, stop:0 rgba(226, 226, 226, 0), stop:0.954802 rgba(157,157, 157, 0));"
"border-style:none")
        self.groupBox_8.setObjectName("groupBox_8")
        self.buttonloadfile = QtGui.QPushButton(self.groupBox_8)
        self.buttonloadfile.setFocusPolicy(QtCore.Qt.NoFocus)
        self.buttonloadfile.setFlat(True)
        self.buttonloadfile.setGeometry(QtCore.QRect(26, 23, 230, 53))
        self.buttonloadfile.setStyleSheet(
"QPushButton {border-image: url(:/images/0-1.png);}\n\
QPushButton:hover:pressed {border-image: url(:/images/0-2.png);}\n\
QPushButton:hover:!pressed {border-image: url(:/images/0-3.png);}"
);
...
#        self.labelcnmobile.setMaximumSize(QtCore.QSize(23, 20))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.labelcartoonupload.setText(QtGui.QApplication.translate("MainWindow", "动画编码工具", None, QtGui.QApplication.UnicodeUTF8))
